define(function (require, exports, module) {/** Implements interfaces from http://www.w3.org/TR/2011/WD-rdf-interfaces-20110510/ */
...
api.Profile.prototype._resolveType = function(type) {
	...
	return this.resolve(type) || (new IRI(type)).value;
}
