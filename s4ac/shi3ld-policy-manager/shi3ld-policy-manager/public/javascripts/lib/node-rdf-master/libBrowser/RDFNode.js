define(function (require, exports, module) {var api = exports;
...
*/
api.Triple = function(s, p, o) { this.subject = s; this.predicate = p; this.object = o; };
 ...
 */
api.Literal = function(value, language) {
	this.value = value;
...
api.IRI.prototype.nodeType = function() { return "IRI" };
api.IRI.prototype.toNT = function() { return"<" + api.encodeString(this.value) + ">" };
api.IRI.prototype.n3 = function() { return this.toNT(); }
api.IRI.prototype.defrag = function() {
	var i = this.value.indexOf("#");
	return (i < 0) ? this : new api.IRI(this.value.slice(0, i))
}
api.IRI.prototype.isAbsolute = function() {
	return this.scheme()!=null && this.heirpart()!=null && this.fragment()==null
}
api.IRI.prototype.toAbsolute = function() {
...
api.IRI.prototype.authority = function() {
...
api.IRI.prototype.fragment = function() {
	var i = this.value.indexOf("#");
	return (i < 0) ? null : this.value.slice(i)
}
api.IRI.prototype.heirpart = function() {
...
api.IRI.prototype.host = function() {
...
api.IRI.prototype.query = function() {
...
api.removeDotSegments = function(input) {
	var output = "";
	var q = 0;
...
api.IRI.prototype.resolveReference = function(ref) {
	var reference;
