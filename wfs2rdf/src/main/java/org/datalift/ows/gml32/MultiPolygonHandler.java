...
/**
 * A specific handler for a multipolygon geometry 
...
public class MultiPolygonHandler extends DefaultHandler{
	...
	public MultiPolygonHandler(SAXParser parser, GeoHandler geoHandler, Stack<ComplexFeature> fpile, DlGeometry g,
