...
public class RDFTransformException extends org.datalift.fwk.TechnicalException {
     ...
     */
    protected RDFTransformException() {
        super();
    }
     ...
     */
    protected RDFTransformException(Throwable cause) {
        super(cause);
    }
     ...
     *                from the format.
     */
    public RDFTransformException(String code, Object... data) {
        super(code, data);
    }
     ...
     *                 from the format.
     */
    public RDFTransformException(String code, Throwable cause, Object... data) {
