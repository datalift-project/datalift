...
public class LovModuleException extends org.datalift.fwk.TechnicalException {
     ...
     */
    protected LovModuleException(Throwable cause) {
        super(cause);
    }
     ...
     *                from the format.
     */
    public LovModuleException(String code, Object... data) {
        super(code, data);
    }
     ...
     *                 from the format.
     */
    public LovModuleException(String code, Throwable cause, Object... data) {
